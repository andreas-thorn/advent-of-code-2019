...
coords_1 = plot_line(line_1)
coords_2 = plot_line(line_2)
intersections = set(coords_1.keys()) & set(coords_2.keys())

shortest_path = None

for intersection in intersections:
    # Get the distance for every intersection.
    distance = abs(coords_1[intersection]) + abs(coords_2[intersection])
    if shortest_path is None or distance < shortest_path:
